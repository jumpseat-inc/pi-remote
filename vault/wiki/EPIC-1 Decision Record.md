...
## Related
[[EPIC-2 Decision Record]] (the follow-on run: the server-side implementation spec), [[EPIC-3 Decision Record]] (the run-hygiene and fixture-pinning follow-on), [[pi-remote]], [[Council Seats]], [[Copy Honesty Doctrine]], [[Spec Correction Governance]], [[Footer Merge Policy]]
