...
- **Explicit over implied, when a missed implication is a wire bug.** FLLWUP-6 form (a): `message_end` got its own §4 row — form (b) was "cheaper to write, not cheaper to reverse" because a reader who misses the footnote drops the end frame.
- **Keys over literal strings.** EV-2 Item 2: literal strings are cheaper today by an hour, more expensive to reverse later (the localization card becomes a refactor across every emission site).
