...
sources: ["[[EV-7 Ruling]]", "[[FLLWUP-7 Design Position r2]]"]
created: 2026-09-02
updated: 2026-09-02
---
...
Known limits: on Windows the ACL test can only run on `gates-windows` (see FLLWUP-16 for its cold-start timeout flake).

## Related
[[Copy Honesty Doctrine]], [[Verify Cycle Cap]], [[login.ts]], [[FLLWUP-7 Design Position r2]]
