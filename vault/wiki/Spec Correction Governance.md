...
sources: ["[[EV-1 Ruling]]", "[[EV-4 Ruling]]", "[[EV-5 Ruling]]", "[[FLLWUP-4 Ruling]]", "[[FLLWUP-5 Ruling]]", "[[EPIC-2 Decision Record]]", "[[Device-Flow Polish Run (BUG-1, FLLWUP-24, FLLWUP-25)]]"]
created: 2026-09-02
updated: 2026-09-23
---
...
- **Citation errata ride the PR; the goal is immutable.** A wrong RFC section in a goal, comment, or plan (FLLWUP-24 cited §3.2 for what is §3.5) is corrected on the implementing PR as evidence-cited prose-sync. The card's `goal` is immutable once `In Progress`, so the fix rides a card-face errata note, never a goal rewrite (FLLWUP-24 product-owner ruling).
...
## Related
[[Cheapest To Reverse]], [[Fixture-Green Honesty]], [[Closed Vocabulary Discipline]], [[Cause-Distinguished Expiry]], [[Council Seats]], [[pi-remote]]

## Sources
[[EV-1 Ruling]], [[EV-4 Ruling]], [[EV-5 Ruling]], [[FLLWUP-4 Ruling]], [[FLLWUP-5 Ruling]], [[Device-Flow Polish Run (BUG-1, FLLWUP-24, FLLWUP-25)]]
